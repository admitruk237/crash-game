...
const VolumeIcon = forwardRef<VolumeIconHandle, Props>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, initialActive = false, ...props }, ref) => {
